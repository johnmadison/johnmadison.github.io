...
function love.load()
	...
	love.graphics.setBackgroundColor(220, 22s0, 255)
	...
	player = 		{
					...
					w = 32,
					standing = false,
					image = love.graphics.newImage("sprites/cupstanding.png")
					}
...
function love.draw()
	...
	love.graphics.rectangle("fill", player.x - player.w/2, player.y - player.h/2, player.wm player.h)
